--[[
    ================================================================
    [ SCRIPT INFORMATION ]
    Project: Cold War ESP v3 — Key System
    Author: BZMEMBER
    ================================================================

    This is the KEY SYSTEM only.
    Run this script to verify your key before loading the main script.
--]]
...
local Config = {
    ServiceId       = 31234,
    PlatoSecret     = "aa57c937-d091-4888-a935-37788252cbce",

    Secret          = "ColdWarESP_v3_AONMO_2026",

    MainScriptURL   = "https://raw.githubusercontent.com/Momonoke-cd/Script-Cold-war/refs/heads/main/main.lua", -- ใส่ raw URL ของ ColdWarESP_Main.lua ถ้าโฮสต์บน GitHub
                          -- ถ้าปล่อยว่าง จะ load จาก script ที่ hosting
    ...
    KeyFileName     = "ColdWarESP_Key.txt",
    OldGuiName      = "ColdWarESP_KeySystem",
    MainGuiName     = "ColdWarScript",

    HubName         = "LONELY HUB",
    HubDescription  = "Enter your key to unlock the script."
}
...
local function StartMainScript()
    ...
    if Config.MainScriptURL and Config.MainScriptURL ~= "" then
        loadstring(game:HttpGet(Config.MainScriptURL))()
    else
        warn("[Cold War ESP] MainScriptURL not set! Please host ColdWarESP_Main.lua and set the URL.")
    end
end
...
local function CreateGUI()
    ...
    if targetParent:FindFirstChild(Config.OldGuiName) then
        targetParent[Config.OldGuiName]:Destroy()
    end

    local ScreenGui = Instance.new("ScreenGui", targetParent)
    ScreenGui.Name = Config.OldGuiName
    ...
    PromoText.Size = UDim2.new(0.9, 0, 0, 35)
